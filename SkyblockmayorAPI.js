fetch("https://api.hypixel.net/v2/resources/skyblock/election")
    ...
    .then(res => {
        ...
        const candidate2 = res.mayor.election.candidates[1];
        let candidate2perks = '';
        ...
        <td>${res.mayor.election.candidates[1].key}</td>
        <td>${candidate2perks}</td>
        <td>${res.mayor.election.candidates[1].votes}</td>
        </tr>`;

        const candidate3 = res.mayor.election.candidates[2];
        let candidate3perks = '';
        ...
        <td>${res.mayor.election.candidates[2].key}</td>
        <td>${candidate3perks}</td>
        <td>${res.mayor.election.candidates[2].votes}</td>
        </tr>`;

        const candidate4 = res.mayor.election.candidates[3];
        let candidate4perks = '';
        ...
        <td>${res.mayor.election.candidates[3].key}</td>
        <td>${candidate4perks}</td>
        <td>${res.mayor.election.candidates[3].votes}</td>
        </tr>`;

        const candidate5 = res.mayor.election.candidates[4];
        let candidate5perks = '';
        ...
        <td>${res.mayor.election.candidates[4].key}</td>
